package de.varylab.varylab.hds.converter;
...
public class UVMeshGenerator {
	...
	public double[][][][] getArray() {
		...
		do {
			VEdge e = se;
			v = 0;
			xyzcoord[u][v][0] = Arrays.copyOf(e.getStartVertex().position,4);
			xyzcoord[u][v++][0][3] = 1;
			while(e.getTargetVertex() != vend) {
				xyzcoord[u][v][0] = Arrays.copyOf(e.getTargetVertex().position,4);
				xyzcoord[u][v++][0][3] = 1;
				e = getOpposingEdge(e);
			} 
			xyzcoord[u][v][0] = Arrays.copyOf(e.getTargetVertex().position,4);
