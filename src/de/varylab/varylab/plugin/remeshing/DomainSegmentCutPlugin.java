...
public class DomainSegmentCutPlugin extends AlgorithmPlugin {

	@Override
	public String getAlgorithmName() {
		return "Cut texture segment";
	}
	...
	> void execute(HDS hds, AdapterSet a, HalfedgeInterface hif) {
		...
		Selection cutSelection = TextureUtility.cutSegment(hds, vSet, hif.getAdapters());
