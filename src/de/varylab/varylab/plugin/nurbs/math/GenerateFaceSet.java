...
public class GenerateFaceSet {
	...
	public static int getShiftedIndexFromIntersectionPointAndCurveIndex(IntersectionPoint ip, int curveIndex){
...
//			System.out.println("firstCoord "+Arrays.toString(firstCoordFromIndexedSegment)+" iP "+Arrays.toString(iP.point)+" iP.sameIndexDist " + iP.sameIndexDist);
	...
	public LinkedList<HalfedgePoint> findAllNbrs(NURBSSurface ns, double dilation, LinkedList<IntersectionPoint> intersectionPoints){
...
//			LinkedList<Integer> indexList = getIndexListFromIntersectionPoint(iP1);
			...
			for (Integer i : iP1.getIndexList()){
...
//			System.out.println("BOUNDARY " + ip.getClosedBoundary(ns, dilation));
			return false;
		}
//		System.out.println("HHHHHAAAAALLLLLOOOOO!!!!!");
		return true;
	}
