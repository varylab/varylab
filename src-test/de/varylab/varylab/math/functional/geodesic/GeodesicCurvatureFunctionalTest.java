...
public class GeodesicCurvatureFunctionalTest extends FunctionalTest<DefaultJRVertex, DefaultJREdge, DefaultJRFace> {
	...
	private GeodesicCurvatureFunctional<DefaultJRVertex, DefaultJREdge, DefaultJRFace>
		fun = new GeodesicCurvatureFunctional<DefaultJRVertex, DefaultJREdge, DefaultJRFace>();
